...
See the [docs](https://docs.rs/bab_rs/latest) too.

The `pkg/package.json` file is automatically generated by `wasm-pack` when you
run the build script (`npm run build`). The `package.json` data comes from
`./Cargo.toml`.
